...
try:
    from ..core.backend import ContainerGroupItem, ContainerItem, ProjectState
    from ..core.shared import NODE_HEIGHT, NODE_WIDTH, _load_algorithm_studio_settings, _save_algorithm_studio_settings
except ImportError:
    from core.backend import ContainerGroupItem, ContainerItem, ProjectState
    from core.shared import NODE_HEIGHT, NODE_WIDTH, _load_algorithm_studio_settings, _save_algorithm_studio_settings
...
class AlgorithmStudioIdentityMixin:
    ...
    def _ensure_singleton_container_group(self, project: ProjectState) -> None:
        ...
        if has_member:
            self.project.set_scene_position(root_group, self._scene_storage_key("graph"), left, top)
