...
try:
    ...
    from bridge.agent_client import MockAgentClient as _LegacyMockAgentClient
    from bridge.agent_client import generate_cpp_skeleton
    from bridge.interface4agents import build_interface4agents_prompt, execute_interface4agents_command, extract_interface4agents_script
