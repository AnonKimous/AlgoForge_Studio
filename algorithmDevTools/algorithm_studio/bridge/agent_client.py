...
try:
    from ..core.backend import ProjectState
    from .interface4agents import build_interface4agents_prompt
    from ..core.shared import PROJECT_ROOT, _resolve_codex_command
except ImportError:
    from core.backend import ProjectState
    from bridge.interface4agents import build_interface4agents_prompt
    from core.shared import PROJECT_ROOT, _resolve_codex_command
    ...
    def _document_tool_instructions(self) -> str:
        ...
        return "\n".join(
            [
                ...
                "```",
                "Rules:",
                "- ui_add_node supported kinds: container, containerelement, container_group, containergroup, variable, array, stage, resnode, function, functiontext, reflector.",
