# algorithmDevTools Agent Guide

## Scope

This `algorithmDevTools` workspace hosts the algorithmDevTools editor, its agent bridge, and its teaching skills.

- Main desktop app: `algorithmDevTools/algorithm_studio/algorithm_studio.py`
- Agent bridge: `algorithmDevTools/algorithm_studio/agents.py`
