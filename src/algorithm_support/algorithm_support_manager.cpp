...
MeshCoderOutput AlgorithmSupportManager::BuildMeshCoderOutput(const Mesh& mesh) const {
...
ImpactModelCoderOutput AlgorithmSupportManager::BuildImpactModelCoderOutput(const ImpactModelSource& source, size_t max_particles) const {
...
MeshCommonReflection AlgorithmSupportManager::ReflectMeshCommon(const Mesh& mesh) const {
...
ExplicitPointReflection AlgorithmSupportManager::ReflectPointById(const Mesh& mesh, int32_t point_id) const {
...
VolumeDescriptor AlgorithmSupportManager::BuildVolumeDescriptorFromMesh(const Mesh& mesh, float mass, Vec3 driving_dir) const {
