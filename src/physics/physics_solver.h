...
class PhysicsSolver {
 public:
  ...
  void ApplyValidDirectives(Mesh& mesh);
  ...
  PhysicsStepInput BuildStepInput(const Mesh& mesh) const;
 ...
 private:
  ...
  void PropagateTriangleTension(const PhysicsStepInput& input, PhysicsStepOutput& output) const;
};
