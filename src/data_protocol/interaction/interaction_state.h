...
using foundation::GuideEditMode;
using foundation::GuideUiFrame;
using foundation::InteractionFrame;
using foundation::InteractionMode;
using foundation::PhysGuideKeyframe;
using foundation::PhysRecordedFrame;
using foundation::RenderFrameResult;
using foundation::RenderUiState;
using foundation::SelectionKind;
using foundation::SelectionState;
