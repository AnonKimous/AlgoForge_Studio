...
bool _PreparePipelineStage0Submission(
  ...
  if (!algomanager::PrepareAlgorithmObjectByName(
...
bool _TickAlgorithmObject(
  ...
  if (!algomanager::SubmitAlgorithmObject(
        object,
        context,
        runtime_state->agent_to_algorithm_signal,
...
BuiltAlgorithmMount _BuildAlgorithmMount(
  ...
  if (!algomanager::FinalizeAlgorithmObject(
        object,
...
bool CreateAlgorithmObjectByName(
  ...
  const bool created =
    algomanager::CreateAlgorithmObjectFromLocation(
      package_location,
      out_group,
      out_error_message,
      load_reflector);
...
bool QueryAlgorithmRequestedBindingsByName(
  ...
  if (!algomanager::QueryAlgorithmPackageRequestedBindingsFromLocation(
        package_location,
...
bool Agent::MountPipelineAlgorithm(
  ...
  return algomanager::MountPipelineAlgorithmObjects(
    &algorithm_objects_,
...
bool Agent::RemoveAlgorithm(size_t index) {
  ...
  algomanager::UnregisterMountedPipelineObject(object_to_remove, agent_name_);
  return true;
}
...
void Agent::RefreshInterventionSignals(const AgentTickContext& context) {
  for (size_t i = 0; i < algorithm_objects_.size(); ++i) {
    ...
    algomanager::RefreshAlgorithmObjectSignals(
...
bool Agent::SubmitAlgorithm(
  ...
  auto process_algorithm_index = [&](size_t index) {
    ...
    if (!algomanager::TickAlgorithmObject(
          object,
          runtime_state,
          agent_name_,
          context,
...
bool Agent::EnqueuePipelineStage0Submission(
  ...
  return algomanager::EnqueueMountedPipelineStage0Submission(
    &algorithm_objects_,
    pipeline_name,
    agent_name_,
    resource_bindings,
...
bool Agent::ReplayPipelineStageBridgeDebug(
  ...
  return algomanager::ReplayMountedPipelineDebugNode(
...
void Agent::Destroy() {
  algomanager::UnregisterMountedPipelineObjects(algorithm_objects_, agent_name_);
  initialized_ = false;
  agent_name_.clear();
