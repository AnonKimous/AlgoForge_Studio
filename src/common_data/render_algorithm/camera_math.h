...
using common_data::RenderAlgorithm_BuildCenteredViewMatrix;
using common_data::RenderAlgorithm_BuildOrthoProjectionMatrix;
using common_data::RenderAlgorithm_WorldToNdc;
using common_data::RenderAlgorithm_WorldToWindow;
using common_data::RenderAlgorithm_WindowToWorld;
