...
bool BuildPipelineStageContainerSets(
  const std::vector<::algorithmManager::scheduler::AlgorithmObject>& algorithm_objects,
  size_t begin_index,
  size_t end_index,
...
inline bool BuildPipelineStageContainerSets(
  ...
  for (size_t index = begin_index; index < end_index; ++index) {
    const ::algorithmManager::scheduler::AlgorithmObject& object = algorithm_objects[index];
...
class AlgorithmScheduler {
 public:
  ...
  bool TickMountedPipeline(
    ...
    const std::vector<::algorithmManager::AlgorithmAssemblyState>& assembly_states,
...
inline bool CreateAlgorithmObjectFromLocation(
  ...
  std::string* out_error_message = nullptr,
  bool load_reflector = true) {
  return algorithmManager::catalog::CreateAlgorithmObjectFromLocation(
    package_location,
    out_group,
    out_error_message,
    load_reflector);
...
inline bool QueryAlgorithmRequestedBindings(
  ...
  return algorithmManager::catalog::QueryAlgorithmPackageRequestedBindingsFromLocation(
    package_location,
...
inline bool LoadAlgorithmPackageDefaultBindings(
  ...
  return algorithmManager::catalog::LoadAlgorithmPackageDefaultBindingsFromLocation(
    package_location,
...
inline bool FinalizeAlgorithmObject(
  const ::agentmanager::agent::AlgorithmObject& algorithm_object,
  ::algorithm::AlgorithmContainerSet* container_set,
  std::string* out_error_message = nullptr) {
  if (!container_set) {
    if (out_error_message) {
  ...
  const bool ok = algorithmManager::catalog::DecomposeAlgorithmPackageFromLocation(
    package_location,
...
inline bool PrepareAlgorithmObjectByName(
  ...
  const std::vector<AlgorithmResourceBinding>& resource_bindings,
  const std::vector<AlgorithmDescriptorValue>& descriptor_values,
  ::agentmanager::agent::AlgorithmObject* out_object,
  std::string* out_error_message = nullptr,
  bool load_reflector = true) {
  if (!out_object) {
    if (out_error_message) {
  ...
  ::agentmanager::agent::AlgorithmObject prepared_object{};
...
inline uint64_t HashPipelineGroupState(
  const std::vector<::algorithmManager::AlgorithmObject>& algorithm_objects,
  ...
  const std::vector<::algorithmManager::AgentAlgorithmRuntimeState>& runtime_states,
  size_t begin_index,
  size_t end_index) {
  uint64_t hash = kFnvOffsetBasis64;
  for (size_t index = begin_index; index < end_index; ++index) {
    const ::algorithmManager::AlgorithmObject& object = algorithm_objects[index];
...
inline void CollectDebugState(
  ...
  if (auto* complex_support = dynamic_cast<::algorithmManager::IComplexAlgorithmPackageSupport*>(object.reflector.get())) {
    if (out_debug_state) {
...
class NoOpPipelineWrapperJobsExecutor final : public ::algorithmManager::IAlgorithmJobsExecutor {
 public:
...
inline BuiltAlgorithmMount BuildAlgorithmMount(
  ...
  const std::vector<AlgorithmResourceBinding>& resource_bindings,
  const std::vector<AlgorithmDescriptorValue>& descriptor_values,
  ::algorithmManager::AlgorithmMountMode mount_mode,
  ...
  const bool use_shared_standard_container =
    mount_mode == ::algorithmManager::AlgorithmMountMode::StandardContainer &&
...
inline BuiltAlgorithmMount BuildEmptyPipelineWrapperMount(
  const ::algorithmManager::AlgorithmObject& body_stage0_object,
  const std::string& wrapper_algorithm_name,
  ::algorithmManager::AlgorithmPipelineWrapperRole wrapper_role,
  ::algorithmManager::AlgorithmExecutionPreference execution_preference) {
  BuiltAlgorithmMount result{};
  ...
  result.object.mount_mode = ::algorithmManager::AlgorithmMountMode::Pipeline;
  result.object.execution_preference = ::algorithmManager::AlgorithmExecutionPreference::Jobs;
...
inline std::string DefaultPipelineWrapperAlgorithmName(
  ...
  ::algorithmManager::AlgorithmPipelineWrapperRole wrapper_role) {
  const char* suffix = wrapper_role == ::algorithmManager::AlgorithmPipelineWrapperRole::Begin
    ? "_stageBegin"
    : "_stageEnd";
...
inline BuiltAlgorithmMount BuildPipelineWrapperMount(
  ...
  const ::agentmanager::agent::AlgorithmObject& body_stage0_object,
  const algorithmManager::catalog::AlgorithmPipelineWrapperStageSpec& stage_spec,
  ::algorithmManager::AlgorithmPipelineWrapperRole wrapper_role,
  ::algorithmManager::AlgorithmExecutionPreference execution_preference,
  std::unordered_map<std::string, std::shared_ptr<algorithm::AlgorithmContainerSet>>* standard_shared_container_sets) {
...
inline bool PipelineNameInUse(
  const std::vector<::algorithmManager::AlgorithmObject>& mounted_objects,
  const std::string& pipeline_name) {
  if (pipeline_name.empty()) {
    return false;
  }
  for (const ::algorithmManager::AlgorithmObject& object : mounted_objects) {
...
inline bool FindMountedPipelineRange(
  ...
  for (size_t index = 0u; index < mounted_objects.size(); ++index) {
    const ::algorithmManager::AlgorithmObject& anchor = mounted_objects[index];
    ...
    while (begin_index > 0u) {
      const ::algorithmManager::AlgorithmObject& previous = mounted_objects[begin_index - 1u];
    ...
    while (end_index < mounted_objects.size()) {
      const ::algorithmManager::AlgorithmObject& next = mounted_objects[end_index];
...
inline bool InitializePipelineInterStageBufferRuntimeState(
  const ::agentmanager::agent::AlgorithmObject& stage0_object,
  const std::string& stage_buffer_slot_name,
...
inline IoBufferPacket BuildAlgorithmInterventionPacket(
  ...
  return algorithmManager::catalog::BuildAlgorithmInterventionPacket(descriptor);
}

inline bool DecodeAlgorithmInterventionPacket(
  const IoBufferPacket& packet,
  DecodedAlgorithmIntervention* decoded) {
  return algorithmManager::catalog::DecodeAlgorithmInterventionPacket(packet, decoded);
}

inline IoBufferPacket BuildAlgorithmInterventionPacket(
  const InteractionInterventionRequest& request) {
  return algorithmManager::catalog::BuildAlgorithmInterventionPacket(request);
}

inline bool DecodeAlgorithmInterventionPacket(
  const IoBufferPacket& packet,
  InteractionInterventionRequest* request) {
  return algorithmManager::catalog::DecodeAlgorithmInterventionPacket(packet, request);
}
...
inline bool AlgorithmScheduler::EnqueuePipelineStage0Submission(
  ...
  ::agentmanager::agent::AlgorithmObject prepared_stage0_object{};
...
inline bool AlgorithmScheduler::MountPipelineAlgorithmObjects(
  ...
  if (!algorithmManager::catalog::LoadAlgorithmPipelineWrapperSpecFromLocation(
        root_package_location,
        &wrapper_spec,
  ...
  if (topology == ::algorithmManager::AlgorithmPipelineTopology::Circular &&
  ...
  if (has_wrapper_nodes) {
    const ::algorithmManager::AlgorithmExecutionPreference wrapper_begin_preference =
    ...
    pipeline_scheduler_detail::BuiltAlgorithmMount wrapper_begin_mount =
      pipeline_scheduler_detail::BuildPipelineWrapperMount(
        ...
        ::algorithmManager::AlgorithmPipelineWrapperRole::Begin,
  ...
  if (has_wrapper_nodes) {
    const ::algorithmManager::AlgorithmExecutionPreference wrapper_end_preference =
    ...
    pipeline_scheduler_detail::BuiltAlgorithmMount wrapper_end_mount =
      pipeline_scheduler_detail::BuildPipelineWrapperMount(
        ...
        ::algorithmManager::AlgorithmPipelineWrapperRole::End,
  ...
  if (topology == ::algorithmManager::AlgorithmPipelineTopology::NonCircular &&
...
inline bool AlgorithmScheduler::EnqueueMountedPipelineStage0Submission(
  ...
  std::vector<::algorithmManager::AlgorithmObject>& algorithm_objects = *mounted_objects;
  ...
  ::algorithmManager::AlgorithmObject& stage0_object = algorithm_objects[body_stage0_index];
  if (stage0_object.execution_preference == ::algorithmManager::AlgorithmExecutionPreference::Jobs) {
...
inline bool AlgorithmScheduler::TickMountedPipeline(
  ...
  std::vector<::algorithmManager::AlgorithmObject>& algorithm_objects = *mounted_objects;
  std::vector<::algorithmManager::AgentAlgorithmRuntimeState>& updated_runtime_states =
    *inout_runtime_states;
  updated_runtime_states.resize(algorithm_objects.size());
  *out_pipeline_signal = {};
  *out_pipeline_processing_failed = false;

  ::algorithmManager::AlgorithmObject& root_object = algorithm_objects[begin_index];
  const bool emit_runner_probe =
  ...
  ::algorithmManager::AlgorithmObject& body_stage0_object = algorithm_objects[body_begin_index];
  const bool pipeline_uses_inter_stage_buffer =
    body_stage0_object.execution_preference == ::algorithmManager::AlgorithmExecutionPreference::Jobs;
  ...
  auto resolve_pipeline_active_bundle = [&](
    ...
    ::algorithmManager::AlgorithmExecutionPreference* out_bundle_preference,
    bool* out_bundle_valid) {
    *out_bundle_begin_stage_index = 0u;
    *out_bundle_stage_count = 0u;
    *out_bundle_preference = ::algorithmManager::AlgorithmExecutionPreference::Vk;
    *out_bundle_valid = false;
    ...
    const ::algorithmManager::AlgorithmExecutionPreference bundle_preference =
  ...
  if (!current_body_stage_has_data.empty() &&
    ...
    ::algorithmManager::AlgorithmObject& stage0_object = body_stage0_object;
    JobsPendingPipelineStage0Submission submission =
  ...
  for (size_t index = begin_index; index < end_index; ++index) {
    ...
    ::algorithmManager::AlgorithmObject& object = algorithm_objects[index];
    ::algorithmManager::AgentAlgorithmRuntimeState runtime_state{};
    ...
    if (collect_pipeline_timing) {
      progress_state.stage_runtime_stats.push_back(::algorithmManager::AlgorithmPipelineStageRuntimeStat{
    ...
    stage_is_ready[stage_offset] =
      ...
      assembly_states[index] == ::algorithmManager::AlgorithmAssemblyState::Ready;
    const bool launch_once_then_hold =
      object.tick_lifetime == ::algorithmManager::AlgorithmTickLifetime::LaunchOnceThenHold;
  ...
  auto tick_stage_without_execution = [&](
    ...
    const size_t stage_offset = index - begin_index;
    ::algorithmManager::AlgorithmObject& object = algorithm_objects[index];
    ::algorithmManager::AgentAlgorithmRuntimeState& runtime_state = updated_runtime_states[index];
  ...
  auto execute_body_stage = [&](
    ...
    algorithmManager::catalog::PipelineStageBridge bridge(object.runtime_transfer_map);
    if (emit_runner_probe) {
      pipeline_scheduler_detail::AppendPipelineRunnerProbe(
        "scheduler_tick_probe.log",
  ...
  auto commit_progress_state = [&](pipeline_scheduler_detail::PipelineGroupProgressState&& applied_progress_state) {
    ...
    ::algorithmManager::AlgorithmExecutionPreference active_bundle_preference =
    ::algorithmManager::AlgorithmExecutionPreference::Vk;
...
inline bool AlgorithmScheduler::ReplayMountedPipelineDebug(
  ...
  ::algorithmManager::AlgorithmObject& object = (*mounted_objects)[index];
  ::algorithmManager::AgentAlgorithmRuntimeState& runtime_state = (*inout_runtime_states)[index];
  ...
  ::algorithmManager::AlgorithmPackageDebugState collected_debug_state{};
