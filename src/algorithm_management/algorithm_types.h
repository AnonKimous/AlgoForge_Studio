...
// Internal algorithm-management data definitions.
...
#error "Do not include algorithm_management/algorithm_types.h directly. Use algorithm_management/algorithm_manager.h."
#endif
