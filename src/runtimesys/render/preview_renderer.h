...
#error "Do not include runtimesys/render/preview_renderer.h directly. Use runtimesys/runtime_environment.h."
#endif
...
class PreviewRenderer {
 public:
  ...
  VkImage PreviewTextureImage() const;
 ...
 private:
  ...
  struct PreviewPipelineResource {
    ...
    uint32_t draw_indirect_buffer_index{UINT32_MAX};
    bool valid{false};
  };
