...
AlgorithmComplianceDescriptor CreateLegacyCorotatedCpuAlgorithmComplianceDescriptor(
  ...
  descriptor.algorithm_name = kLegacyCorotatedCpuAlgorithmName;
  ...
  descriptor.data_contract.algorithm_required_formats = {
    AlgorithmDataFormat{"legacy_corotated_cpu_input", vertex_count, static_cast<uint32_t>(sizeof(Vec3))}
  };
  return descriptor;
}
