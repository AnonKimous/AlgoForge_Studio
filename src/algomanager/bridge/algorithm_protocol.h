...
struct AlgorithmPluginBundle {
  ...
  algomanager::algoscheduler::IAlgorithmVkExecutor* vk_executor{nullptr};
  void (*destroy_vk_executor)(algomanager::algoscheduler::IAlgorithmVkExecutor*){nullptr};

  algomanager::algoscheduler::IAlgorithmCudaExecutor* cuda_executor{nullptr};
  void (*destroy_cuda_executor)(algomanager::algoscheduler::IAlgorithmCudaExecutor*){nullptr};

  algomanager::algoscheduler::IAlgorithmJobsExecutor* jobs_executor{nullptr};
  void (*destroy_jobs_executor)(algomanager::algoscheduler::IAlgorithmJobsExecutor*){nullptr};

  // ABI-tail extension: old version-4 plugins keep the field layout above.
  bool compatibility_symbol{false};
  algomanager::algoscheduler::IAlgorithmCompatibilityExecutor* compatibility_executor{nullptr};
  void (*destroy_compatibility_executor)(algomanager::algoscheduler::IAlgorithmCompatibilityExecutor*){nullptr};
...
struct AlgorithmPluginComponents {
  ...
  std::shared_ptr<algomanager::algoscheduler::IAlgorithmVkExecutor> vk_executor{};
  std::shared_ptr<algomanager::algoscheduler::IAlgorithmCudaExecutor> cuda_executor{};
  std::shared_ptr<algomanager::algoscheduler::IAlgorithmCompatibilityExecutor> compatibility_executor{};
  std::shared_ptr<algomanager::algoscheduler::IAlgorithmJobsExecutor> jobs_executor{};
};
...
bool PipelineStageBridgeIngress(
  ...
  const std::string& target_stage_name,
  const std::unordered_map<std::string, std::shared_ptr<algorithm::AlgorithmContainerSet>>& stage_container_sets,
  const algomanager::algoscheduler::JobsPipelineInterStageBufferRuntimeState& inter_stage_buffer,
  algorithm::AlgorithmContainerSet* out_target_container_set,
  std::string* out_error_message = nullptr);
...
bool PipelineStageBridgeEgress(
  ...
  const std::string& source_stage_name,
  const algorithm::AlgorithmContainerSet& source_container_set,
  algomanager::algoscheduler::JobsPipelineInterStageBufferRuntimeState* inter_stage_buffer,
  std::unordered_map<std::string, std::shared_ptr<algorithm::AlgorithmContainerSet>>* stage_container_sets,
  std::string* out_error_message = nullptr);
...
bool QueryAlgorithmPackageRequestedBindingsFromLocation(
  const algorithm::AlgorithmPackageLocation& package_location,
  algomanager::algoscheduler::AlgorithmRequestedResources* out_requested_resources,
  algomanager::algoscheduler::AlgorithmRequestedDescriptorBindings* out_requested_descriptor_bindings,
  std::string* out_error_message = nullptr);

bool LoadAlgorithmPackageDefaultBindingsFromLocation(
  const algorithm::AlgorithmPackageLocation& package_location,
  std::vector<algomanager::algoscheduler::AlgorithmResourceBinding>* out_resource_bindings,
  std::vector<algomanager::algoscheduler::AlgorithmDescriptorValue>* out_descriptor_values,
...
namespace support = algocatalog;
}  // namespace algomanager

namespace algorithm_library_plugin = algomanager::algocatalog;
