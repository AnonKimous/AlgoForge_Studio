...
using algorithmManager::AlgorithmContainer;
using algorithmManager::AlgorithmContainerSet;
...
using algorithmManager::AlgorithmProfile;
...
using algorithmManager::FindAlgorithmContainer;
