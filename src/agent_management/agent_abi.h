...
class IAlgorithmPackageCodec {
 public:
  ...
  virtual bool BuildMeshCoderOutput(const Mesh& mesh, codec::MeshCoderOutput* out_output) const {
    (void)mesh;
    (void)out_output;
    return false;
  }

  virtual bool ReflectMeshCommon(const Mesh& mesh, codec::MeshCommonReflection* out_reflection) const {
    (void)mesh;
    (void)out_reflection;
    return false;
  }
  ...
  virtual bool BuildVolumeDescriptor(
    ...
    float mass,
    Vec3 driving_dir,
    codec::VolumeDescriptor* out_volume) const {
    (void)mesh;
    (void)mass;
    (void)driving_dir;
    (void)out_volume;
