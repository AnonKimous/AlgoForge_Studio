...
using algorithmManager::catalog::AlgorithmInterventionDescriptor;
using algorithmManager::catalog::AlgorithmInterventionMode;
using algorithmManager::catalog::DecodedAlgorithmIntervention;
