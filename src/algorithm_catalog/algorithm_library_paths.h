...
inline fs::path ResolveAlgorithmLibraryRuntimeDebugRoot() {
  return ResolveFirstExistingPath({
...
inline fs::path ResolveAlgorithmLibraryRuntimeReleaseWithDebugInfoRoot() {
  return ResolveFirstExistingPath({
    "../../algorithmLib/algorithmruntimeLib/releaseWithDebugInfo",
    "../../../algorithmLib/algorithmruntimeLib/releaseWithDebugInfo",
    "../algorithmLib/algorithmruntimeLib/releaseWithDebugInfo",
    "algorithmLib/algorithmruntimeLib/releaseWithDebugInfo",
  }, PathType::Directory);
...
inline fs::path ResolveAlgorithmLibraryRuntimeRoot(AlgorithmLibraryRuntimeBuildFlavor flavor) {
  switch (flavor) {
    case AlgorithmLibraryRuntimeBuildFlavor::Debug:
      return ResolveAlgorithmLibraryRuntimeDebugRoot();
    case AlgorithmLibraryRuntimeBuildFlavor::ReleaseWithDebugInfo:
      return ResolveAlgorithmLibraryRuntimeReleaseWithDebugInfoRoot();
  }
  return ResolveFirstExistingPath({
    "../../algorithmLib/algorithmruntimeLib",
    "../../../algorithmLib/algorithmruntimeLib",
...
inline fs::path ResolveAlgorithmLibraryRuntimeRoot() {
  return ResolveAlgorithmLibraryRuntimeRoot(GetAlgorithmLibraryRuntimeBuildFlavor());
}
