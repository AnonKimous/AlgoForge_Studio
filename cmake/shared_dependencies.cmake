...
function(resolve_assimp_dependency repo_root)
  ...
  set(ASSIMP_INSTALL OFF CACHE BOOL "Generate Assimp install targets" FORCE)
  ...
  resolve_existing_path(_ASSIMP_SOURCE_DIR CMakeLists.txt
    ...
    "${repo_root}/third_party/assimp"
  )
  if(_ASSIMP_SOURCE_DIR)
    set(ASSIMP_SOURCE_DIR "${_ASSIMP_SOURCE_DIR}" CACHE PATH "Assimp source directory" FORCE)
  else()
    message(STATUS "Assimp not found locally; fetching Assimp from GitHub.")
    ...
    set(ASSIMP_SOURCE_DIR "${assimp_source_SOURCE_DIR}" CACHE PATH "Assimp source directory" FORCE)
  endif()

  add_subdirectory(
    "${ASSIMP_SOURCE_DIR}"
    "${CMAKE_BINARY_DIR}/assimp-build"
    EXCLUDE_FROM_ALL
  )
  if(TARGET assimp::assimp)
    set(ASSIMP_LINK_LIBS assimp::assimp PARENT_SCOPE)
  elseif(TARGET assimp)
    set(ASSIMP_LINK_LIBS assimp PARENT_SCOPE)
  else()
    message(FATAL_ERROR "Assimp target was not generated by the third-party project.")
  endif()
endfunction()
