...
#error "Do not include sdk_kernel.h directly. Use sdk/sdk.h."
#endif
...
class SdkKernel {
 public:
  SdkKernel();
  ~SdkKernel();
  SdkKernel(SdkKernel&&) noexcept;
  SdkKernel& operator=(SdkKernel&&) noexcept;
  SdkKernel(const SdkKernel&) = delete;
  SdkKernel& operator=(const SdkKernel&) = delete;
